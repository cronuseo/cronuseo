...
func ResourceRoleRoutes2(router *echo.Echo) {

	resourceActionRouter := router.Group("/resource_roles")

	resourceActionRouter.GET("/:res_id/:id", controllers.GetResourceRole2)
	resourceActionRouter.GET("/:res_id", controllers.GetResourceRoles2)
	resourceActionRouter.POST("/:res_id", controllers.CreateResourceRole2)
	resourceActionRouter.POST("/:res_id/:id/user/:user_id", controllers.AddUserToResourceRole2)
	resourceActionRouter.POST("/:res_id/:id/group/:group_id", controllers.AddGroupToResourceRole2)
	resourceActionRouter.POST("/:res_id/:id/action/:resact_id", controllers.AddResourceActionToResourceRole2)
	resourceActionRouter.DELETE("/:res_id/:id", controllers.DeleteResourceRole2)
	resourceActionRouter.PUT("/:res_id/:id", controllers.UpdateResourceRole2)
}
